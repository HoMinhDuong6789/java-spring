...
public class NewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * request.getRequestDispatcher("/views/admin/new/list.jsp");
		 * rd.forward(request, response);
		 */
		 
		
		  NewModel model = FormUtil.toModel(NewModel.class, request); String view = "";
		  if (model.getType().equals(SystemConstant.LIST)) { Pageble pageble = new
